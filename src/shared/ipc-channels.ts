...
export const IPC_EVENTS = {
  ...
  INSTALL_STARTED: 'capability:install:started',
  INSTALL_VERIFIED: 'capability:install:verified',
  INSTALL_FAILED: 'capability:install:failed',
  POLICY_REWRITE_APPLIED: 'capability:policy:rewrite-applied',
  POLICY_BLOCKED: 'capability:policy:blocked',
  CHECKPOINT_CREATED: 'capability:checkpoint:created',
  ROLLBACK_APPLIED: 'capability:rollback:applied',
  MCP_SERVER_HEALTH: 'capability:mcp:server-health',
  TASK_EVIDENCE_SUMMARY: 'capability:task:evidence-summary',
